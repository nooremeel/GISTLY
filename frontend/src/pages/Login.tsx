    ...
    return (
        <div className="min-h-[100svh] flex flex-col items-center justify-center p-6 bg-paper">
            ...
            <p className="mt-8 text-small text-muted">
                No account?{' '}
                <Link to="/register" className="font-medium text-ink hover:text-accent focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent rounded-sm px-1">
                    Register
                </Link>
            </p>
        </div>
